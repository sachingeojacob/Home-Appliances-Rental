$(document).ready(function(){	
  $("#sregistration").on("submit",function(){
  ...
  $("#lname").focusout(function(){
    ...
    $storename= $('#storename').val();
	if($storename == "" ){
		$('#storename_error').html(" Enter storename");
		return false;
		}
    else if(!val_storename.test($storename)){
		$(this).css('border','2px solid red');
		$('#storename_error').html("Invalid storename , Enter A Valid storename");
		return false;
    }
    else {
		$(this).css('border','NONE');
      ...
      return true;
		...
		$gstnumber= $('#gstnumber').val();
		if($gstnumber == "" ){
		$('#gstnumber_error').html(" Enter gstnumber");
		return false;
		}
		else if(!val_gstnumber.test($gstnumber)){
			$(this).css('border','2px solid red');
	  	  	$('#gstnumber_error').html("Enter A Valid gstnumber , gstnumber Must Contain Numbers Only");
		return false;
		}
		else {
			$(this).css('border','NONE');
