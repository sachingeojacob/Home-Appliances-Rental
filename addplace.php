...
if (isset($_POST['add-place'])) {
    ...
    $subcategoryname = $_POST['place-name'];
    $category_select = $_POST['district-id'];
  // echo $category_select;

    
    
     $sql4="select * from place where place_name='$subcategoryname'";
    ...
    $row8 = mysqli_num_rows($result1);
     ...
     echo '<script> alert("Place Already Existed! ")</script>';
}
    }
...
<form method="post" action="" style="text-align: center;">
            <select class="input-box" name="district-id" id="category_select">
            ...
            <input type="text" class="input-box" name="place-name">
            <input type="submit" name="add-place" value="Add" class="submit-button" placeholder="Country name here">
        </form>
        ...
        <div class="available-countries">
          ...
          while($row = mysqli_fetch_assoc($result)) {
            echo '<h5>'.$row["place_name"].' <a href="delete-place.php?pid='.$row["place_id"].'" class="delete-button">X</a></h5>';
          }
          ?>
        </div>
